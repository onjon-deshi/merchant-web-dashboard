        ...
        <div className="w-3/5">
            ...
            <div className="bg-neutral-100 p-9 text-secondary ">
                ...
                <form onSubmit={onSubmit} className="form-body">
                    <div className="mb-4">
                        <input type={type1} name={name1} className="w-full p-3 rounded-lg mb-4" autoComplete='off' maxLength={maxLength} placeholder={placeholder1} />
                        <input type={type2} name={name2} className="w-full p-3 rounded-lg" placeholder={placeholder2} />
