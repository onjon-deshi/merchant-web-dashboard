        ...
        <div className="App flex font-montserrat w-full">
            ...
            <div className="flex flex-col justify-center w-1/2">
                <Routes>
                    ...
                    <Route path="/add-email" element={<AddForm title="Your Email Here" type="email" name="email" subtitle="Provide the email you want to associate with your merchant account. We'll send a link there for verification" placeholder="Email" />} />
